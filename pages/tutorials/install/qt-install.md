---
title: Install Qt
permalink: /pages/tutorials/install/qt-install.html
layout: page
...
{% include image.html file="/resources/tutorials/install/qt/qt-install0.png" width="75%" %}

{% include image.html file="/resources/tutorials/install/qt/qt-install1.png" width="75%" %}
Select the latest version for Qt “Desktop gcc 64 bit”. The screenshot below is just for illustrative purposes.
{% include image.html file="/resources/tutorials/install/qt/qt-install2.png" width="75%" %}
