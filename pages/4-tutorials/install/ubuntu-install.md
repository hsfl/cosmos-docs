...
permalink: /pages/4-tutorials/install/ubuntu-install.html
layout: page
...
### Install Qt
For Qt Installation process, follow [these instructions]({{site.baseurl}}/pages/4-tutorials/install/qt-install.html).
