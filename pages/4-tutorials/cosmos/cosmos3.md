...
permalink: /pages/4-tutorials/cosmos/cosmos3.html
layout: series
...
series:
    ...
    next: /pages/4-tutorials/cosmos/cosmos4.html
---
...
{% include image.html file="/resources/4-tutorials/cosmos/part3/build.png" width="100%" %}
...
{% include image.html file="/resources/4-tutorials/cosmos/part3/cloud9.png" %}
...
{% include image.html file="/resources/4-tutorials/cosmos/part3/run_agent.png" %}
...
{% include image.html file="/resources/4-tutorials/cosmos/part3/call_request.png" width="100%" %}
